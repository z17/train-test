...
const resultVariants = {
    ...
    [RESULT_2]: {
        title: "Купе",
        text: "Вы замкнуты и недоверчивы, ваш круг общения состоит из 3-4 человек, зато с ними вы отлично находите общий язык. Вы покидаете свой тесный мирок только по крайней необходимости и, скорее всего, Вы не страдаете клаустрофобией. Похоже, Вы - купе-вагон.",
        image: "",
        attachment: ""
    },
    [RESULT_3]: {
